...
'*----------------------------------------------------------------------*
'* Modulo           : DPMAccess - Estructura DB en MS-Access            *
...
'*------------|------|-------------------------------------|------|-----*
'* 19/02/2021 | 01-1 | Creacion del modulo DPMAccess       | 2010 | 4.0 *
'*------------|------|-------------------------------------|------|-----*

Public Class DPMAccess
	'Variables Publicas Modulo: DPMAccess
	Public FHoy As Date
	...
	Private Sub DPMAccess_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '*-------------------------------------------------------------------------------------------------*
        '* PMovilD - Pago Movil Dynamics                                              R1.V0.M0 (Prerelase) *
        '* JR Sistemas24, Co.                                                         Fecha: 12/02/2021    *
        '*-------------------------------------------------------------------------------------------------*
        '* Modulo           : DPMAccess - Revisar estructura de BD: PMovilD - Access                       *
        '* Rutina           : DPMAccess_Load ---> Carga el formato DPMAccess                               *
